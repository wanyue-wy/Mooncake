   ...
   protected:
    ...
    void ValidateMountedSegments(const SegmentManager& segment_manager,
        ...
        for (size_t i = 0; i < client_ids.size(); i++) {
            ...
            ASSERT_EQ(seg.segment.GetCentralizedExtra().base, segments[i].GetCentralizedExtra().base);
...
TEST_F(SegmentTest, MountSegmentSuccess) {
    ...
    segment.GetCentralizedExtra().base = 0x100000000;
...
TEST_F(SegmentTest, MountSegmentDuplicate) {
    ...
    segment2.GetCentralizedExtra().base = segment.GetCentralizedExtra().base + segment.size;
...
TEST_F(SegmentTest, ReMountSegmentSuccess) {
    ...
    segment_a.GetCentralizedExtra().base = 0x100000000;
    ...
    segment_b.GetCentralizedExtra().base = 0x200000000;
...
TEST_F(SegmentTest, QuerySegments) {
    ...
    for (int i = 0; i < 10; i++) {
        ...
        segment.size = 1024 * 1024 * 16;
        segment.GetCentralizedExtra().base =
