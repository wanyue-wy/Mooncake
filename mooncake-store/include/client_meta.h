...
class ClientMeta {
   ...
   public:
     ...
     * Attention: if client is CRASHED, the hearbeat will not be updated.
   ...
   protected:
    ...
    std::pair<ClientStatus, ClientStatus> UpdateHealthStatus();
   ...
   protected:
    ...
    mutable SharedMutex health_mutex_;
    UUID client_id_;
    ClientHealthState health_state_ GUARDED_BY(health_mutex_);
};
