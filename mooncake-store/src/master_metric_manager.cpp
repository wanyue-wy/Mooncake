...
MasterMetricManager::MasterMetricManager()
    ...
    : mem_allocated_size_(
      ...
      get_read_route_requests_("master_get_read_route_requests_total",
                               "Total number of get read route requests"),
      get_read_route_failures_(
          "master_get_read_route_failures_total",
          "Total number of failed get read route requests"),
...
void MasterMetricManager::inc_get_read_route_requests(int64_t val) {
    get_read_route_requests_.inc(val);
}
void MasterMetricManager::inc_get_read_route_failures(int64_t val) {
...
int64_t MasterMetricManager::get_get_read_route_requests() {
    return get_read_route_requests_.value();
}
int64_t MasterMetricManager::get_get_read_route_failures() {
